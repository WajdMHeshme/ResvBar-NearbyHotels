            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center mb-4">
                    <input
                        id="remember_me"
                        type="checkbox"
                        class="rounded border-gray-300 text-sky-600 shadow-sm focus:ring focus:ring-sky-200 focus:ring-opacity-50"
                        name="remember"
                    >
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    @if (Route::has('password.request'))
                        <a class="text-sm text-sky-600 hover:text-sky-800 underline" href="{{ route('password.request') }}">

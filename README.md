<div align="center">
  <img src="public/assets/images/logo.png" alt="ResvBAR Logo" width="400">
</div>
...
## 📍 ملاحظة مهمة بخصوص الموقع (Geolocation)

⚠️ **هذا التطبيق يعتمد على تحديد موقع المستخدم الحالي** لعرض الفنادق القريبة.

- يجب السماح للمتصفح بالوصول إلى **موقعك الجغرافي** عند الطلب.
- في حال رفض الإذن:
  - لن يتم تحديد موقعك.
  - ولن تظهر الفنادق القريبة على الخريطة.
- إذا قمت برفض الإذن بالخطأ، يمكنك إعادة تفعيله من:
  - إعدادات المتصفح (Location / Site Settings)
  - ثم إعادة تحميل الصفحة.

> يُنصح باستخدام **Google Chrome** للحصول على أفضل تجربة
